<?php  //[STAMP] a3c34d05b680af34ed5a8401e6751c55
// phpcs:ignoreFile
...
trait AcceptanceTesterActions
{
     ...
     * @see \Tests\Support\Helper\Acceptance::generateTestPuzzleCode()
     */
    public function generateTestPuzzleCode(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('generateTestPuzzleCode', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Acceptance::waitForTextWithRetry()
     */
    public function waitForTextWithRetry(string $text, int $timeout = 30, int $retries = 3): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('waitForTextWithRetry', func_get_args()));
    }
